...
@Service
@Slf4j
public class ReporteWSA2Local {

	final String templateWSA2 = "C:\\opt\\gacelaConfig\\filesTemplates\\forecastWSA2.xlsx";
	...
	public XSSFWorkbook generarReporte(Forecast forecast) {
		...
		try {
			...
			FileInputStream fis = new FileInputStream(new File(this.templateWSA2));
			...
			sheet1.getRow(1).getCell(0).setCellValue("BOOKING FOR WSA2 - Servicio EVL WSA2");
